...
module.exports = Object.freeze({
    ...
    /*http config*/
    http:{
        //host_dev: "qmaster.localhost.com",
        host_dev: "10.17.17.1",
        port_dev: 88,
        host_pro: "qmaster.qmobile.vn",
        port_pro: 88
    },

    /*ldap config*/
    ldap:{
        admin       : "dev.dn-001@abtel.com.vn",
        password    : "QmObile*#@",
        baseAdmin   : "dc=abtel,dc=com,dc=vn",
        url         : "ldap://10.1.1.11",
        urls        : "ldaps://10.1.1.11",
        port        : 389,
        searchBase  : "dc=abtel,dc=com,dc=vn",
        //searchFilter: "(uid={{username}})"
        searchFilter: "(objectClass=user)(objectCategory=person)",
        attributes  : ['dn','samaccountname','name','mail','employeeid','telephonenumber','title','useraccountcontrol','distinguishedname','pager']
    },
