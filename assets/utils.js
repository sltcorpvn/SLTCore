...
var formatToFrontDate = function(date){
...
var formatToFrontDateTime = function(date){
...
var formatToDBDate = function(date){
    if(date == "" || date == null)
        return date;
...
/* check email format */
var isEmailFormat = function(str){
    var emailFormat = /^[\w\.]+\@[\w\.]+$/;
